...
TEST_CASE("controller protocol serializes observation for external bots") {
  ...
  observation.self = robolocks::UnitSnapshot{
    ...
    .mobility_intent = robolocks::MobilityIntentSnapshot{
      .active = true,
      .target = robolocks::Vec2{20.0, 12.0},
      .remaining_m = 14.0,
      .age_ticks = 2,
    },
    .turret_intent = robolocks::AimIntentSnapshot{
      .active = true,
      .target = robolocks::Vec2{34.0, 12.0},
      .error_deg = 4.5,
      .age_ticks = 1,
    },
    .weapon_intent = robolocks::WeaponIntentSnapshot{
      .active = true,
      .min_hit_chance = 0.6,
      .age_ticks = 3,
    },
