...
uint64_t robolocks_battle_runner_unit_weapon_cooldown_ticks(RobolocksBattleRunnerHandle handle, size_t unit_index);
...
double robolocks_battle_runner_unit_mobility_intent_remaining_m(RobolocksBattleRunnerHandle handle, size_t unit_index);
uint64_t robolocks_battle_runner_unit_mobility_intent_age_ticks(RobolocksBattleRunnerHandle handle, size_t unit_index);
...
double robolocks_battle_runner_unit_turret_intent_error_deg(RobolocksBattleRunnerHandle handle, size_t unit_index);
uint64_t robolocks_battle_runner_unit_turret_intent_age_ticks(RobolocksBattleRunnerHandle handle, size_t unit_index);
...
uint64_t robolocks_battle_runner_unit_hull_intent_age_ticks(RobolocksBattleRunnerHandle handle, size_t unit_index);
...
uint64_t robolocks_battle_runner_unit_weapon_intent_age_ticks(RobolocksBattleRunnerHandle handle, size_t unit_index);
